const Intro = () => {
  return (
    <div className='flex items-center justify-center flex-col text-center pt-6 pb-6'>
      ...
      <p className='text-headline text-base md:text-xl mb-3 font-medium underline underline-offset-8 decoration-2 decoration-button '>
        Full Stack Engineer
      </p>
      <p className='text-sm max-w-[670px] mb-6 font-bold text-paragraph'>
